var sys = (function () {
    ...
    var init, Success, convertNull, Notsuccessfully,
        ...
        _PageNumberAjax, _setSkip, _sizePageDefault, dateCurrent, formatDateTimeVN, grenbarcode, getbarcode, getbarcodeFlashShip, Getlatlocation, Getlnglocation, _getGroupPemition, GetUserCookie,
        formatDateTime, formatDateTimeT, GetFullnameCookie, numberToVietName, BoDauTiengViet;
    ...
    formatDateTimeT = function (_date, format) {
        if (_date !== null) {
            var date = _date;

            var subStrDate = date.replace('T', ' ');
            var parseIntDate = subStrDate;
            var date = new Date(parseIntDate);
    ...
    formatDateTimeVN = function (date, time) {
        if (date !== null) {
            var _date = date.split('-');
            var _dateYear = _date[0];
            var _dateMonth = _date[1];
            var _date1 = _date[2];
            var _date2 = _date1.split("T");
            var _dateDay = _date2[0];
            var _date3 = _date2[1].split(":");
            var _dateHoure = _date3[0];
            var _dateMinute = _date3[1];
            var _dateSeconds = _date3[2];
            if (time) {
                return _dateDay + "-" + _dateMonth + "-" + _dateYear + " " + _dateHoure + ":" + _dateMinute
            } else {
    ...
    getbarcodeFlashShip = //function jen barcode
        function getbarcodeFlashShip(mahd) {
            var html;
            var value = mahd;
            var btype = "code128";
            var renderer = "css";
    ...
    return {
        ...
        formatDateTimeT: formatDateTimeT,
        ...
        getbarcodeFlashShip: getbarcodeFlashShip,
